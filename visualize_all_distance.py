...
ax.plot(list(range(1, 101)), misalignments, label="misalignment", color="red")
print(misalignments)
print(numbers_cell)
ax.plot(list(range(1, 101)), list(range(1, 101)), linestyle="dashed")
ax.set_ylim(bottom=0)
ax.set_xlabel("threshold d on matching")
ax2 = ax.twinx()
ax.set_ylabel("mean of misalignment between obs and pred")
ax2.plot(list(range(1, 101)), numbers_cell, label="number of cell", color="blue")
